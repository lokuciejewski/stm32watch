...
void write_date(void) {
	...
	HAL_I2C_Mem_Write(&hi2c1, (DS3231_I2C_ADDRESS << 1), 0x4, 1, &bcd_day,
			1, 1000);
	HAL_I2C_Mem_Write(&hi2c1, (DS3231_I2C_ADDRESS << 1), 0x5, 1, &bcd_month,
			1, 1000);
	HAL_I2C_Mem_Write(&hi2c1, (DS3231_I2C_ADDRESS << 1), 0x6, 1, &bcd_year, 1,
			1000);
}
